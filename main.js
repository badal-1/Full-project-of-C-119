...
document.getElementById("s-t-b-d").innerHTML="Sketch to be drawn: "+sketch;
function setup(){
canvas = createCanvas(180,180);
canvas.center();
background("white");
canvas.mouseReleased(classifyCanvas);
sv = window.speechSynthesis;
}
...
document.getElementById('p1').innerHTML = "Your Sketch is: " + results[0].label;
document.getElementById('confidence').innerHTML = 'Confidence: ' + Math.round(results[0].confidence*100) + '%';
utterthis= new SpeechSynthesisUtterance('What you had to draw was ' + sketch + 'The sketch which you have drawn is ' + results[0].label + "with confidence" + Math.round(results[0].confidence*100) + '%'); 
sv.speak(utterthis);   
}
function draw(){
check_sketch();
